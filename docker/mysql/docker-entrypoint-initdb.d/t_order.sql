...
CREATE TABLE `config` (
                        ...
                        `description` varchar(255) DEFAULT NULL COMMENT '配置详情',
...
CREATE TABLE `message` (
                         ...
                         `description` varchar(255) NOT NULL COMMENT '消息详情',
...
CREATE TABLE `order` (
                       ...
                       `description` varchar(255) NOT NULL COMMENT '订单详情',
...
(1,	'管理员列表',	'admin:read',	'2019-03-27 07:42:13',	'2019-03-27 07:42:13'),
...
CREATE TABLE `role` (
                      ...
                      `description` varchar(255) DEFAULT NULL COMMENT '角色组详情',
...
CREATE TABLE `role_permission_relation` (
                                          ...
                                          `gmt_modified` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
                                          PRIMARY KEY (`id`),
                                          UNIQUE KEY `role_permission_relation_permission_id_uindex` (`permission_id`)
...
CREATE TABLE `user` (
                      ...
                      `back_card` varchar(255) DEFAULT NULL COMMENT '银行卡号',
...
INSERT INTO `user` (`id`, `username`, `password`, `back_card`, `score`, `pid`, `is_enabled`, `gmt_create`, `gmt_modified`) VALUES
(2,	'root',	'$2a$10$6dqAS73smpYqNcRw4UY4xOHKv4S3Q.bX2bsKtGysYYfwsZcgqDs2.',	NULL,	0,	NULL,	1,	'2019-03-27 02:33:54',	'2019-03-27 07:03:44');
